...
共 1143 則事件，時間範圍西元前 3000 年至
西元 2026 年（見 `src/topics/world/timeline.yaml`）。全部事件皆附維基百科出處（1790 條連結，中/日/英三個站台，均已透過維基 API 驗證條目存在且非消歧義頁）。
...
- **台灣經濟發展史**（`/tw-economy/`）：欄位是**產業**——農業、工業、科技業。
  153 則事件，1624 至 2026 年，附 231 條出處連結：223 條維基百科（中／英兩個
