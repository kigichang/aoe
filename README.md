...
- **世界藝術史**（`/art/`）：欄位是**門類**——造形、建築、音樂、文學與表演。
  ...
  歌劇剛剛被發明出來」。
- **台灣發展史**（`/tw-development/`）：欄位是**產業**——農業、工業、科技業。
  137 則事件，1624 至 2026 年，附 206 條出處連結：198 條維基百科（中／英兩個
...
- **台灣政治與政黨發展史**（`/tw-politics/`）：欄位是**地區**——台灣、中國。
  199 則事件，1858 至 2026 年，附 270 條出處連結：269 條維基百科（中文站台，
  去重後 242 個條目均已透過 API 驗證存在且非消歧義頁），另有 1 條指向全國法規
  資料庫，補維基沒有條目的《國家安全法》。這是除了世界史之外唯一照地區分欄的主題，
