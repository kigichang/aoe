...
站上還有另一個主題「台灣鐵道史」（`/tw-railway/`），共 98 則事件，
時間範圍 1885 至 2026 年，附 84 條維基百科出處（同樣驗證過）。台鐵、高鐵捷運、糖鐵三欄已走完完整查證流程，林鐵礦鐵一欄仍是種子資料。

以及「世界科學史」（`/science/`），共 190 則事件，時間範圍西元前 3000 年至
西元 2026 年，附 296 條維基百科出處（中／英兩個站台，同樣驗證過）。
這個主題的欄位不是地區而是**學科**——數學、物理與化學、天文與地球、
生命與醫學。世界史那個主題已經在做地理對照，再做一次沒有新東西；
照學科分欄才問得出「牛頓寫《原理》那年，生物學還在爭論生物會不會
自然發生」這種問題（見 `src/topics/science/topic.yaml` 的說明）。
