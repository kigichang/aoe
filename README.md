...
以及「世界宗教史」（`/religion/`），共 236 則事件，時間範圍西元前 3000 年至
西元 2026 年，附 304 條維基百科出處（中／日／英三個站台，同樣驗證過）。
這個主題的欄位不是地區而是**傳統** —— 古代（兩河・埃及・希臘羅馬・伊朗）、
亞伯拉罕、印度、東亞；理由是宗教會跨地理走動，照地區切會把同一個傳統的
因果鏈剪斷（見 `src/topics/religion/topic.yaml` 的說明）。
